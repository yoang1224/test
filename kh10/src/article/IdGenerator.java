...
public class IdGenerator {
	...
	public int generateNextId(String sequenceName) throws IdGenerationFailedException{
		...
		try {
			...
			pstmtSelect = conn.prepareStatement("select next_value from id_sequence1224 "+
			...
			pstmtUpdate = conn.prepareStatement("update id_sequence1224 set next_value=?" + " where sequence_name=?");
